      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <Image src="/logo-gradient.jpeg" alt="MediFamily" width={140} height={42} className="h-10 w-auto brightness-0 invert" />
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-xs text-gray-400">
            <a href="https://medi--log.vercel.app" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">
              Open App
            </a>
